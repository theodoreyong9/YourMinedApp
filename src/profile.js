...
function _generateProfileSphere(cfg){
  ...
  var spheresBlock=[
    ...
    '    // Afficher la sphère même sans peerSection/profileSection (comme la vraie vue visiteur)',
    '    if(!sph)return;',
    '    var sIcon=sph.icon||"\u29e1";',
    ...
    '        }else if(typeof sph.profileSection==="function"){',
    '          sph.profileSection(bd);',
    '        }else{',
    '          var _noSec=document.createElement("div");',
    '          _noSec.style.fontSize="12px";_noSec.style.color="var(--text3,rgba(228,230,244,.3))";',
    '          _noSec.textContent=sph.description||"Active";',
    '          bd.appendChild(_noSec);',
    '        }',
    '      }catch(e2){',
