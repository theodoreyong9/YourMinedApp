...
async function render(containerArg){
  ...
  addBtn.addEventListener('click',()=>{
    if(_publishOpen){
      _publishOpen=false;
      addBtn.textContent='+';addBtn.style.cssText='flex-shrink:0;width:32px;height:32px;border-radius:50%;background:var(--gold);border:none;color:#06060e;font-size:20px;font-weight:300;cursor:pointer;display:flex;align-items:center;justify-content:center;line-height:1;transition:all .15s';
